...
int main(int argc, char **argv)
{
	...
	ros::init(argc, argv, "stereo_dso_ros_dataset");
	ros::NodeHandle nh;
	fullSystem->outputWrapper.push_back(new IOWrap::ROSOutputWrapper("/pointCloudMap", "/camPose", "/camTraj", "map", lw, nh));
	...
	for (IOWrap::Output3DWrapper *ow : fullSystem->outputWrapper)
	{
		...
		ow->saveResults("/media/E/All_codes/A_lab/A_grad/results.bag");
		ow->join();
		delete ow;
	}
